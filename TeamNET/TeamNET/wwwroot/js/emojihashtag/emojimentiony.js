...
; ( function ( factory, global ) {
    ...
    function init(self, source, options) {
        ...
        $.ajax({
            method: "GET",
            url: "https://localhost:44343/Account/GetRole/" + userId,
            dataType: "json",
        ...
        $('#mycomment').mentiony({
            onDataRequest: function (mode, keyword, onDataRequestCompleteCallback) {
                if (role == 1 && statusId <=2) {
                    var hashtags = document.getElementsByClassName('mentiony-link');
                    var temporary = [];
                    if (hashtags.length != 0) {
                        for (let i = 0; i < hashtags.length; i++) {
                            temporary.push(parseInt(hashtags[i].dataset.itemId));
                        }
                    }
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            for (var i = 0; i < response.length; i++) {
                                if (!temporary.includes(response[i].abilityId)) {
                            ...
                            topability = 0;
                                topability -= data.length * 35;
                            document.getElementsByClassName("mentiony-popover")[0].style.top = `${topability}px`;
            ...
            app: app.addClass("mentiony-container"),
            editor: editor.addClass("mentiony-content"),
            inputWidth: 300,
